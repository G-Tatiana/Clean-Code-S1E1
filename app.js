...
const taskInput=document.querySelector('.add .row__input');//Add a new task.
const addButton=document.querySelectorAll('.add__button')[0];//first button
const incompleteTaskHolder=document.querySelector('.todo .list');//ul of #incompleteTasks
const completedTasksHolder=document.querySelector('.completed .list');//completed-tasks
...
const createNewTaskElement=function(taskString){
  ...
  editButton.classList.add('button', 'edit', 'row__button');

  deleteButton.classList.add('button', 'delete', 'row__button');
